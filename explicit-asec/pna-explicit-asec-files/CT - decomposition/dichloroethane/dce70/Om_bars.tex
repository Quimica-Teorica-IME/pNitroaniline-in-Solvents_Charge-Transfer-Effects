...
width=7.000 cm, height=3.0cm,xmin=0, xmax=11,
...
xtick={1, 5, 10},
xticklabels={$1(1)a$, $5(1)a$, $10(1)a$},
ymin=-0.0, ymax=1,
ybar stacked, bar width=0.467 cm]
\addplot[ybar, draw=black, fill=cyan] table[x index=0, y index=4] {Om_bar_data.txt};
\addlegendentry{ACT};
\addplot[ybar, draw=black, fill=orange] table[x index=0, y index=5] {Om_bar_data.txt};
\addlegendentry{NCT};
\addplot[ybar, draw=black, fill=gray] table[x index=0, y index=6] {Om_bar_data.txt};
\addlegendentry{RCT};
\addplot[ybar, draw=black, fill=blue] table[x index=0, y index=7] {Om_bar_data.txt};
\addlegendentry{ALE};
...
% \addplot[ybar, draw=black, fill=yellow!50] table[x index=0, y index=10] {Om_bar_data.txt};
% \addlegendentry{2-el.};
% Handles for arrows
\node at (axis cs: 1,-0.15) (h1) {};
\node at (axis cs: 5,-0.15) (h2) {};
\node at (axis cs: 10,-0.15) (h3) {};
\end{axis}
