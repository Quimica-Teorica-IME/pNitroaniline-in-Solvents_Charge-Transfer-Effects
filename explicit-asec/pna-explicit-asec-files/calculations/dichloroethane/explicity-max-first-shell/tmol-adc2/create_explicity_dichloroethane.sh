...
if [ $# -eq 0 ]
  then
    echo "Indique o nome do arquivo sem a extencao xyz para converter em input do turbomole. Valido apenas para solvente  dce - dichloroethane."
    exit
fi
if [[ "$1" == *"xyz"* ]]; then
...
cat solvent.tmol | awk  '{if( NR%8 == 1 || NR%8 == 0 ) ch="-0.2000" ;else if( NR%8 == 2 || NR%8 == 5 ) ch="-0.0060" ;else ch="0.1030"  ; printf "%9.5f  %9.5f %9.5f  %9.6f\n", $1,$2,$3,ch}' >> pointcharges
