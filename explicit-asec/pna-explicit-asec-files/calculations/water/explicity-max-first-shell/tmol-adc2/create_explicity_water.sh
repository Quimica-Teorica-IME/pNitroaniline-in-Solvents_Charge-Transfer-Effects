...
if [ $# -eq 0 ]
  then
    echo "Indique o nome do arquivo sem a extencao xyz para converter em input do turbomole. Valido apenas para solvente  agua."
    exit
fi
if [[ "$1" == *"xyz"* ]]; then
...
cat solvent.tmol | awk  '{if( NR%3 == 1) ch="-0.8476" ;else  ch="0.4238"  ; printf "%9.5f  %9.5f %9.5f  %9.6f\n", $1,$2,$3,ch}' >> pointcharges
