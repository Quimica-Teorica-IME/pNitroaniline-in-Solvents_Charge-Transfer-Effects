...
width=7.000 cm, height=3.0cm,xmin=0, xmax=16,
...
xtick={1, 7, 15},
xticklabels={$2(1)a$, $7(1)a$, $15(1)a$},
ymin=-0.0, ymax=1,
ybar stacked, bar width=0.311 cm]
...
\node at (axis cs: 7,-0.15) (h2) {};
\node at (axis cs: 15,-0.15) (h3) {};
\end{axis}
